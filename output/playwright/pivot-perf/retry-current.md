- application "Spreadsheet Designer" [ref=f2e5]:
  ...
  - form "Formula bar" [ref=f2e151]:
    ...
    - textbox "公式输入" [disabled] [ref=f2e169]:
      ...
      - text: Category
  - generic [ref=f2e170]:
    - grid "Spreadsheet canvas" [ref=f2e236]:
      - scrollbar "horizontal scrollbar" [ref=f2e239]
      - scrollbar "vertical scrollbar" [ref=f2e241]
  ...
  - contentinfo [ref=f2e212]:
    - generic "Workbook status bar" [ref=f2e213]:
      - generic [ref=f2e214]:
        ...
        - status "Sparse clipboard occupied cells are required and bounded" [ref=f2e233]: 已断线 · 编辑暂停
