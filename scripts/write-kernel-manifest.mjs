...
const manifest = { artifact: fileName, bytes: bytes.byteLength, sha256: createHash('sha256').update(bytes).digest('hex'), source: 'cargo build -p kernel-host --target wasm32-unknown-unknown --release' };
