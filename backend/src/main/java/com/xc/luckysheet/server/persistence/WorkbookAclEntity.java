...
@Entity
@Table(name = "workbook_acl", indexes = @Index(name = "workbook_acl_subject_idx", columnList = "subject,unit_id"))
public class WorkbookAclEntity {
    @EmbeddedId
    private Id id;
    ...
    public static class Id implements Serializable {
        ...
        public Id(String unitId, String subject) {
            this.unitId = unitId;
        ...
        public boolean equals(Object object) {
            ...
            return Objects.equals(unitId, other.unitId) && Objects.equals(subject, other.subject);
        }

        @Override
        public int hashCode() {
            return Objects.hash(unitId, subject);
        }
    }
}
