...
public interface WorkspaceSpaceEntityRepository extends JpaRepository<WorkspaceSpaceEntity, String> {
    ...
    Optional<WorkspaceSpaceEntity> findFirstByOwnerSubjectAndTypeOrderByCreatedAtAsc(String ownerSubject, com.xc.luckysheet.server.contract.WorkspaceSpaceType type);
