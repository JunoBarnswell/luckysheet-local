...
export const EXCEL_SHORTCUT_MANIFEST: readonly ExcelParityItem[] = [
  ...
  shortcut({ id: 'paste-special-alt-e-s', gesture: 'Alt+E,S', commandId: 'clipboard.pasteSpecial', status: 'pass' }),
  ...
  shortcut({ id: 'table-ctrl-l', gesture: 'Ctrl+L', commandId: 'table.create', status: 'pass' }),
...
const STATIC_PARITY_ITEMS: readonly ExcelParityItem[] = [
  ...
  { id: 'object.form-controls', scope: 'object', class: 'core-executable', officialSource: 'https://support.microsoft.com/en-US/Excel/overview-of-forms-form-controls-and-activex-controls-on-a-worksheet', commandId: 'drawing.add.form-control', status: 'pass', testId: 'form-control.canonical-chain' },
  { id: 'object.screenshot-host-capture', scope: 'object', class: 'core-executable', officialSource: 'https://support.microsoft.com/en-us/office/insert-a-screenshot-or-screen-clipping-669e8f6f-4c1f-4c6d-9f3c-2b8c8e8cb8e4', commandId: 'drawing.add.image', status: 'pass', testId: 'screenshot.asset-capture' },
