...
export const RIBBON_COMMAND_CATALOG: readonly CommandDefinition[] = [
  ...
  styleCommand('orientationRotateUp', RIBBON_TEXT.commands.orientationRotateUp, 'type', () => ({ textOrientation: 'rotateUp', textRotate: 0 }), (context) => context.cellStyle.textOrientation === 'rotateUp', 'alignment'),
  styleCommand('orientationRotateDown', RIBBON_TEXT.commands.orientationRotateDown, 'type', () => ({ textOrientation: 'rotateDown', textRotate: 0 }), (context) => context.cellStyle.textOrientation === 'rotateDown', 'alignment'),
