...
export const CORE_INTERACTION_CASES: readonly CoreInteractionAcceptanceCase[] = [
  ...
  coreInteraction('CORE-018', 'local formula calculation and IndexedDB restore work without an API request', 'formula', 'e2e/spreadsheet.spec.ts', ['domain', 'mutation', 'browser', 'persistence'], ['formula result', 'IndexedDB restore', 'no API request'], 'local-reload'),
