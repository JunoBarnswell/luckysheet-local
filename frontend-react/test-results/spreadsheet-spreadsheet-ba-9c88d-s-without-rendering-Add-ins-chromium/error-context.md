...
- Name: spreadsheet.spec.ts >> spreadsheet baseline >> Home ribbon opens shared format, sort, find, and paste dialogs without rendering Add-ins
- Location: e2e\spreadsheet.spec.ts:374:3
...
Call log:
  - waiting for getByRole('button', { name: /(sort range|排序区域)/i })
