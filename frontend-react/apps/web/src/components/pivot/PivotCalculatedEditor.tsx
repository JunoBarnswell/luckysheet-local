...
import type { PivotCalculatedFieldDefinition, PivotCalculatedItemDefinition, PivotFieldDefinition } from './types';

export interface PivotCalculatedEditorProps {
  fields: readonly PivotFieldDefinition[];
  calculatedFields: readonly PivotCalculatedFieldDefinition[];
  calculatedItems: readonly PivotCalculatedItemDefinition[];
  disabled?: boolean;
  onFieldsChange: (fields: PivotCalculatedFieldDefinition[]) => void;
  onItemsChange: (items: PivotCalculatedItemDefinition[]) => void;
}
