...
const SPECIAL_KINDS: Array<{ id: GoToSpecialKind; labelKey: HomeUiTextKey }> = [
  ...
  { id: 'constant-numbers', labelKey: 'constantNumbers' },
  { id: 'constant-text', labelKey: 'constantText' },
  { id: 'constant-logical', labelKey: 'constantLogical' },
  { id: 'constant-errors', labelKey: 'constantErrors' },
  { id: 'formulas', labelKey: 'formulas' },
  { id: 'formula-numbers', labelKey: 'formulaNumbers' },
  { id: 'formula-text', labelKey: 'formulaText' },
  { id: 'formula-logical', labelKey: 'formulaLogical' },
  { id: 'formula-errors', labelKey: 'formulaErrors' },
  ...
  { id: 'conditional-format-all', labelKey: 'conditionalFormatAll' },
  { id: 'conditional-format-same', labelKey: 'conditionalFormatSame' },
  { id: 'data-validation', labelKey: 'dataValidation' },
  { id: 'data-validation-all', labelKey: 'dataValidationAll' },
  { id: 'data-validation-same', labelKey: 'dataValidationSame' },
  { id: 'current-region', labelKey: 'currentRegion' },
  { id: 'current-array', labelKey: 'currentArray' },
  { id: 'row-differences', labelKey: 'rowDifferences' },
  { id: 'column-differences', labelKey: 'columnDifferences' },
  { id: 'precedents', labelKey: 'precedents' },
  { id: 'dependents', labelKey: 'dependents' },
