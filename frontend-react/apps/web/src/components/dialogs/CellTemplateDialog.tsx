  ...
  return (
    <Dialog open={open} title="单元格样式模板" onClose={onClose} maxWidth="lg">
      <Stack gap="md">
        ...
        <Inline gap="sm" className="justify-end"><Button size="sm" variant="ghost" onClick={onClose}>关闭</Button><Button size="sm" variant="primary" disabled={!name.trim()} onClick={save}>保存模板</Button></Inline>
