...
export function WorkbookActionBar({ selectedCount, onCreate, onImport, onExportSelected, onSyncSelected, onMoveSelected, canExport = true, canSync = true }: WorkbookActionBarProps) {
  ...
  return (
    <Inline gap="sm" className="min-h-10 flex-wrap justify-between">
      <Inline gap="sm">
        ...
        {onMoveSelected ? <Button disabled={!hasSelection} icon="folder" onClick={onMoveSelected} size="sm" variant="secondary">移动</Button> : null}
      </Inline>
