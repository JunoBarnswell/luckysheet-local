...
import { ensureSparseSize, isSparseGrid } from "./sparseGrid";

function isFormulaString(f) {
...
export { setcellvalue, setAccuracy, isFormulaString };
