export default {
    ...
    sort: {
        ...
        formulaIntersectError: "排序區域與陣列公式或動態陣列溢出範圍相交，已中止排序。",
        filterMenuSingleColumnLimit: "篩選選單內排序僅支援當前單列；多列排序請使用自訂排序。",
    },
    filter: {
        "filter"     : "篩選",
        "clearFilter": "清除篩選",
    ...
    websocket: {
        ...
        reconnecting: 'WebSocket已斷開，正在重連…',
        reconnectFailed: 'WebSocket重連失敗，請刷新頁面！',
    },
    exportXlsx:{
        notice:'請配置導出插件',
        serverError:'服務器正在維護',
        ...
        currentSheet: "當前工作表",
        allSheets: "所有工作表",
        emptyUrl: "導出地址為空，請配置 plugins[{name:'exportXlsx'}].config.url",
        networkError: "導出請求失敗，請檢查網絡與導出服務",
        invalidResponse: "導出服務未返回有效的 xlsx 檔",
        httpError: "導出服務返回錯誤",
    }
