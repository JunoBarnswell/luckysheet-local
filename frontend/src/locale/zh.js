export default {
    ...
    sort: {
        ...
        formulaIntersectError: "排序区域与数组公式或动态数组溢出范围相交，已中止排序。",
        filterMenuSingleColumnLimit: "筛选菜单内排序仅支持当前单列；多列排序请使用「自定义排序」。",
    },
    filter: {
        filter: "筛选",
        clearFilter: "清除筛选",
    ...
    findAndReplace: {
        ...
        formulaTextbox: "按公式文本查找",
        workbookTextbox: "在整个工作簿中查找",
    ...
    insertLink: {
        ...
        range: "单元格区域",
        linkDefineName: "名称",
        placeholderDefineName: "请输入已定义的名称，如 MyRange",
        tooltipInfoDefineName: "未找到该定义名称",
        linkAddress: "链接地址",
        linkSheet: "工作表",
        linkCell: "单元格引用",
        linkTooltip: "提示",
    ...
    dataVerification: {
        ...
        custom: "自定义公式",
        list_multiple: "下拉多选",
        placeholderCustom: "请输入公式，如 =A1>0",
        tooltipInfoCustom: "自定义公式不能为空",
    ...
    websocket: {
        ...
        reconnecting: "WebSocket已断开，正在重连…",
        reconnectFailed: "WebSocket重连失败，请刷新页面！",
    },
    note: {
        title: "备注",
        cell: "单元格备注",
    ...
    exportXlsx: {
        ...
        currentSheet: "当前工作表",
        allSheets: "所有工作表",
        emptyUrl: "导出地址为空，请配置 plugins[{name:'exportXlsx'}].config.url",
        networkError: "导出请求失败，请检查网络与导出服务",
        invalidResponse: "导出服务未返回有效的 xlsx 文件",
        httpError: "导出服务返回错误",
    },
};
