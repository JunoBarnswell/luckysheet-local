export default {
    ...
    sort:{
        ...
        formulaIntersectError: "El rango de ordenación intersecta una fórmula de matriz o un spill de matriz dinámica. Ordenación cancelada.",
        filterMenuSingleColumnLimit: "La ordenación del menú de filtro es de una sola columna. Use Orden personalizado para varias claves.",
    },
    filter:{
       filter:"crear filtro",
       ...
       conditionCellCustom: "Personalizado",
       filterAnd: "Y",
       filterOr: "O",
    ...
    websocket:{
        ...
        reconnecting: 'WebSocket desconectado, reconectando…',
        reconnectFailed: 'Falló la reconexión de WebSocket, actualice la página.',
    },
    exportXlsx:{
        ...
        emptyUrl: "La URL de exportación está vacía. Configure plugins[{name:'exportXlsx'}].config.url",
        networkError: "Falló la solicitud de exportación. Revise la red y el servicio.",
        invalidResponse: "El servicio de exportación no devolvió un xlsx válido.",
        httpError: "El servicio de exportación devolvió un error",
    }
  };
