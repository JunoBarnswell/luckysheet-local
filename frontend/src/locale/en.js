export default {
    ...
    sort: {
        ...
        formulaIntersectError: "The sort range intersects an array formula or dynamic-array spill. Sort aborted.",
        filterMenuSingleColumnLimit: "Sort in the filter menu is single-column only. Use Custom Sort for multiple keys.",
    },
    filter: {
    ...
    findAndReplace: {
        ...
        formulaTextbox: "Find in formula text",
        workbookTextbox: "Search entire workbook",
    ...
    insertLink: {
        ...
        defineName: "Defined name",
        range: "Range",
        linkDefineName: "Name",
        placeholderDefineName: "Enter a defined name, e.g. MyRange",
        tooltipInfoDefineName: "Defined name not found",
    ...
    dataVerification: {
        ...
        list_multiple: "Multi-select list",
        placeholderCustom: "Enter a formula, e.g. =A1>0",
        tooltipInfoCustom: "Custom formula cannot be empty",
    ...
    paste: {
        ...
        pasteValues: "Paste values only",
        pasteFormat: "Paste format only",
        noCopyRange: "Nothing to paste. Copy cells first.",
    },
    pivotTable: {
        title: "Pivot Table",
        closePannel: "Close",
    ...
    print: {
        ...
        sectionPage: "Page",
        sectionScale: "Scale",
        sectionRender: "Display",
        sectionHeader: "Header & footer",
        sectionWatermark: "Watermark",
        headerCenter: "Header",
        footerCenter: "Footer",
    ...
    websocket: {
        ...
        reconnecting: "WebSocket disconnected, reconnecting…",
        reconnectFailed: "WebSocket reconnect failed, please refresh the page!",
    },
    note: {
        title: "Note",
        cell: "Cell note",
    ...
    exportXlsx: {
        ...
        emptyUrl: "Export URL is empty. Set plugins[{name:'exportXlsx'}].config.url",
        networkError: "Export request failed. Check the network and the export service.",
        invalidResponse: "Export service did not return a valid xlsx file.",
        httpError: "Export service returned an error",
    },
};
