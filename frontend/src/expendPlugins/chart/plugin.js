...
// Local UMD copies (vue@2.6.11 / vuex@3.4.0 / element-ui@2.13.2 / echarts@4.8.0). No unpkg/CDN.
const CHART_VENDOR = "./expendPlugins/chart/vendor";

const dependScripts = [
    CHART_VENDOR + "/vue.min.js",
    CHART_VENDOR + "/vuex.min.js",
    CHART_VENDOR + "/element-ui/index.js",
    CHART_VENDOR + "/echarts.min.js",
    "./expendPlugins/chart/chartmix.umd.min.js",
];

const dependLinks = [
    CHART_VENDOR + "/element-ui/theme-chalk/index.css",
