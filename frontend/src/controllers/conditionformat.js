...
function applyCfHighlight(computeMap, r, c, textColor, cellColor, stopIfTrue) {
    if (isCfCellStopped(computeMap, r, c)) {
        return false;
    }
    const key = r + "_" + c;
    if (key in computeMap) {
        computeMap[key]["textColor"] = textColor;
        computeMap[key]["cellColor"] = cellColor;
    } else {
        computeMap[key] = { "textColor": textColor, "cellColor": cellColor };
    }
    if (stopIfTrue) {
        computeMap[key]._stopIfTrue = true;
    }
    return true;
}

function matchCfNumberOp(conditionName, cellV, v0, v1) {
    switch (conditionName) {
        ...
        case "betweenness":
        case "between": {
            let vBig = v0 > v1 ? v0 : v1;
            let vSmall = v0 > v1 ? v1 : v0;
            return cellV >= vSmall && cellV <= vBig;
        }
        case "notBetween": {
            let vBig = v0 > v1 ? v0 : v1;
            let vSmall = v0 > v1 ? v1 : v0;
...
function matchCfTextOp(conditionName, cellV, v0) {
    const s = cellV == null ? "" : cellV.toString();
    const t = v0 == null ? "" : v0.toString();
    switch (conditionName) {
        case "textContains":
        ...
        case "endsWith":
            return s.length >= t.length && s.slice(s.length - t.length) === t;
        case "notContains":
            return s.indexOf(t) == -1;
        default:
            return false;
...
function isCfDualValueOp(conditionName) {
    return conditionName == "betweenness" || conditionName == "between" || conditionName == "notBetween";
}

function isCfNumberOp(conditionName) {
    return (
        ...
        isCfDualValueOp(conditionName)
    );
}

function isCfTextOp(conditionName) {
    return (
        conditionName == "textContains" ||
        conditionName == "beginsWith" ||
        conditionName == "endsWith" ||
        conditionName == "notContains"
    );
}

function readStopIfTrue($root) {
    const $box = $root && $root.length ? $root : $(document);
    return $box.find("#checkStopIfTrue").is(":checked");
}
...
const conditionformat = {
    ...
    textCellColorHtml: function(){
        ...
        return `<div id="textCellColor">
                    ...
                    <div class="colorbox">
                        <input id="checkStopIfTrue" type="checkbox">
                        <label for="checkStopIfTrue">${conditionformat_Text.stopIfTrue || "Stop if true"}</label>
                    </div>
                </div>`;
    },
    selectRange: [],
    ...
    init: function(){
            ...
            if(index == 0){
                ...
                if(index == 1){
                    if(type1 == "number"){ //单元格值
                        ...
                        conditionName = type2 || "textContains";
                ...
                rule = toLsRule({
                    ...
                    "stopIfTrue": readStopIfTrue($("#luckysheet-newConditionRule-dialog"))
                });
            }
        ...
        $(document).off("click.CFeditorConditionRuleConfirm").on("click.CFeditorConditionRuleConfirm", "#luckysheet-editorConditionRule-dialog-confirm",function(){
            ...
            if(index == 0){
                ...
                rule = toLsRule({
                    ...
                    "conditionRange": conditionRange,
                    "conditionValue": conditionValue,
                    "stopIfTrue": readStopIfTrue($("#luckysheet-editorConditionRule-dialog"))
                });
            }
        ...
        $(document).off("click.CFdefault").on("click.CFdefault", "#luckysheet-conditionformat-dialog-confirm", function(){
            ...
            //条件值
            let conditionValue = [];
            if(conditionName == "greaterThan" || conditionName == "lessThan" || conditionName == "equal" || conditionName == "textContains" || conditionName == "notEqual" || conditionName == "gte" || conditionName == "lte" || conditionName == "beginsWith" || conditionName == "endsWith" || conditionName == "notContains"){
            ...
            else if(conditionName == "betweenness" || conditionName == "notBetween"){//介于 / 不介于
            ...
            let rule = toLsRule({
                ...
                "conditionRange": conditionRange,
                "conditionValue": conditionValue,
                "stopIfTrue": readStopIfTrue($("#luckysheet-conditionformat-dialog"))
            });
            let ruleArr = Store.luckysheetfile[getSheetIndex(Store.currentSheetIndex)]["luckysheet_conditionformat_save"] == undefined ? [] : Store.luckysheetfile[getSheetIndex(Store.currentSheetIndex)]["luckysheet_conditionformat_save"];
            ruleArr.push(rule);
            Store.luckysheetfile[getSheetIndex(Store.currentSheetIndex)]["luckysheet_conditionformat_save"] = ruleArr;
    ...
    getConditionRuleName: function(conditionName, conditionRange, conditionValue){
        ...
        if(conditionName == "greaterThan"){
        ...
        else if(conditionName == "betweenness" || conditionName == "notBetween"){
            let v2;
            ...
            const label = conditionName == "notBetween" ? conditionformat_Text.notBetween : conditionformat_Text.between;
            return conditionformat_Text.cellValue + " " + label + " " + v + " " + conditionformat_Text.in + " " + v2 + " " + conditionformat_Text.between2;
        }
        ...
        else if(conditionName == "gte" || conditionName == "greaterThanOrEqual"){
            return conditionformat_Text.cellValue + " ≥ " + v;
        }
        else if(conditionName == "lte" || conditionName == "lessThanOrEqual"){
            return conditionformat_Text.cellValue + " ≤ " + v;
        }
        else if(conditionName == "textContains"){
            return conditionformat_Text.cellValue + conditionformat_Text.contain + " =" + v;
        }
        else if(conditionName == "beginsWith"){
            return conditionformat_Text.cellValue + " " + conditionformat_Text.beginsWith + " " + v;
        }
        else if(conditionName == "endsWith"){
            return conditionformat_Text.cellValue + " " + conditionformat_Text.endsWith + " " + v;
        }
        else if(conditionName == "notContains"){
            return conditionformat_Text.cellValue + " " + conditionformat_Text.notContains + " " + v;
        }
    ...
    editorConditionRuleDialog: function(){
        ...
        if(ruleType == "dataBar" || ruleType == "colorGradation" || ruleType == "icons"){
            ...
            if(isCfNumberOp(conditionName) || isCfTextOp(conditionName) || conditionName == "occurrenceDate"){
                index = 1;

                if(isCfNumberOp(conditionName)){
                    type1 = "number";
                }
                else if(isCfTextOp(conditionName)){
                    type1 = "text";
                }
                else if(conditionName == "occurrenceDate"){
                    type1 = "date";
        ...
        if(ruleType == "dataBar" || ruleType == "colorGradation" || ruleType == "icons"){
            ...
            if(type1 == "number"){
                ...
                if(isCfDualValueOp(conditionName)){
                ...
                $("#luckysheet-editorConditionRule-dialog .textBox #type2").val(conditionName);
            ...
            $("#luckysheet-editorConditionRule-dialog #checkStopIfTrue").prop("checked", !!rule.stopIfTrue);
        }
    },
                                        ...
                                        <div>
                                            <div class="type1Box numberBox">
                                                <select id="type2">
                                                    ...
                                                    <option value="notEqual">${conditionformat_Text.notEqual}</option>
                                                    <option value="notBetween">${conditionformat_Text.notBetween}</option>
                                                    <option value="gte">${conditionformat_Text.gte}</option>
                                                    <option value="lte">${conditionformat_Text.lte}</option>
                                                </select>
                                            ...
                                            <div class="type1Box textBox" style="display: none;">
                                                <select id="type2">
                                                    <option value="textContains">${conditionformat_Text.contain}</option>
                                                    <option value="beginsWith">${conditionformat_Text.beginsWith}</option>
                                                    <option value="endsWith">${conditionformat_Text.endsWith}</option>
                                                    <option value="notContains">${conditionformat_Text.notContains}</option>
                                                </select>
                                                <div class="inpbox range" id="conditionVal">
                                                    <input class="formulaInputFocus"/>
                                                    <i class="fa fa-table" aria-hidden="true" title="${conditionformat_Text.selectCell}"></i>
    ...
    getComputeMap: function(sheetIndex){
        ...
        let ruleArr = normalizeConditionFormatSave(Store.luckysheetfile[index]["luckysheet_conditionformat_save"]);
    ...
    compute: function(ruleArr, d){
        ...
        ruleArr = normalizeConditionFormatSave(ruleArr);
            ...
            for(let i = 0; i < ruleArr.length; i++){
                ...
                if(type == "dataBar"){ //数据条
                    ...
                    let conditionName = ruleArr[i].conditionName,         //条件名称
                        ...
                        stopIfTrue = !!ruleArr[i].stopIfTrue;

                    for(let s = 0; s < cellrange.length; s++){
                        //条件类型判断
                        if(isCfNumberOp(conditionName) || isCfTextOp(conditionName)){
                            for(let r = cellrange[s].row[0]; r <= cellrange[s].row[1]; r++){
                                for(let c = cellrange[s].column[0]; c <= cellrange[s].column[1]; c++){
                                    if(d[r] == null || d[r][c] == null){
                                        continue;
                                    ...
                                    let matched = false;
                                    if(isCfTextOp(conditionName)){
                                        matched = matchCfTextOp(conditionName, cell.v, conditionValue0);
                                    }
                                    else{
                                        matched = matchCfNumberOp(conditionName, cell.v, conditionValue0, conditionValue1);
                                    }

                                    if(matched){
                                        applyCfHighlight(computeMap, r, c, textColor, cellColor, stopIfTrue);
                                    }
                                }
                            }
                        }
                                ...
                                for(let x in dmap){
                                    if(x != "null" && x != "undefined" && dmap[x].length > 1){
                                        for(let j = 0; j < dmap[x].length; j++){
                                            applyCfHighlight(computeMap, dmap[x][j].r, dmap[x][j].c, textColor, cellColor, stopIfTrue);
                                        }
                                    }
                                }
                            }
                            if(conditionValue0 == "1"){//唯一值
                                for(let x in dmap){
                                    if(x != "null" && x != "undefined" && dmap[x].length == 1){
                                        applyCfHighlight(computeMap, dmap[x][0].r, dmap[x][0].c, textColor, cellColor, stopIfTrue);
                                    }
                                }
                            }
                        }
