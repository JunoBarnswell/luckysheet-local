...
function rightclickHTML() {
    ...
    const rightclickContainer = `<div id="luckysheet-rightclick-menu" class="luckysheet-cols-menu luckysheet-rightgclick-menu luckysheet-mousedown-cancel">
                ...
                <div id="luckysheet-copy-paste-values" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel" style="display:${
                    config.paste ? "block" : "none"
                };">
                    <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${rightclick.pasteValues || "Paste values"}</div>
                </div>
                <div id="luckysheet-copy-paste-format" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel" style="display:${
                    config.paste ? "block" : "none"
                };">
                    <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${rightclick.pasteFormat || "Paste format"}</div>
                </div>
...
const luckysheetlodingHTML = function(target, coverConfig) {
    ...
    const id = lsId("luckysheet-loading-" + uuid.v4());
    const loadingHtml = `
