...
export default function luckysheetHandler() {
    ...
    $(document).on("mousemove.luckysheetEvent", function(event) {
        ...
        noteCtrl.overshow(event); // cell/sheet note hover
    ...
    $("#luckysheet-copy-paste-values").click(function() {
        selection.pasteSpecial("value");
        $("#luckysheet-rightclick-menu").hide();
    });
    $("#luckysheet-copy-paste-format").click(function() {
        selection.pasteSpecial("format");
        $("#luckysheet-rightclick-menu").hide();
    });
    ...
    $("#luckysheet-exportXlsx-btn-title").click(function() {
        ...
        if(exportXlsxInfo){
            const url = exportXlsxInfo.config && exportXlsxInfo.config.url;
                        ...
                        .each(function() {
                            ...
                            $tr.find(cellElements).each(function() {
                                ...
                                if ($.trim(txt).length == 0) {
                                    ...
                                    let parsed = selection.parseExternalTdValue($td, txt);
                                    cell.v = parsed.v;
                                    cell.ct = parsed.ct;
                                    cell.m = parsed.m;
                                }
