...
assert(snapshot.celldata.every(function (item) { return item.r != null && item.c != null && item.v != null; }), "JSON contract stays celldata sparse");
